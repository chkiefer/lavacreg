...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(compute_groupcond_logl(y, w, z, beta, Beta, gamma, Gamma, Omega, overdis, nu, Lambda, Theta, mu_eta, Sigma_eta, fixeta, ghweight, mu_z, Sigma_z, Sigma_z_lv, fixed_z, cores));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_lavacreg_compute_groupcond_logl", (DL_FUNC) &_lavacreg_compute_groupcond_logl, 21},
    {NULL, NULL, 0}
};
