...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(compute_IRC_groupcond_logl(y, w, z, N, beta, Beta, gamma, Gamma, Omega, overdis, nu, Lambda, Theta, mu_eta, Sigma_eta, fixeta, ghweight, mu_z, Sigma_z, Sigma_z_lv, fixed_z, cfa, cores));
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type cfa(cfaSEXP);
    Rcpp::traits::input_parameter< int const >::type cores(coresSEXP);
    rcpp_result_gen = Rcpp::wrap(compute_groupcond_logl(y, w, z, N, beta, Beta, gamma, Gamma, Omega, overdis, nu, Lambda, Theta, mu_eta, Sigma_eta, fixeta, ghweight, mu_z, Sigma_z, Sigma_z_lv, fixed_z, cfa, cores));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_lavacreg_compute_IRC_groupcond_logl", (DL_FUNC) &_lavacreg_compute_IRC_groupcond_logl, 23},
    {"_lavacreg_compute_groupcond_logl", (DL_FUNC) &_lavacreg_compute_groupcond_logl, 23},
    {NULL, NULL, 0}
};
